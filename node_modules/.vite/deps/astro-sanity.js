// node_modules/astro-sanity/dist/astro-sanity.mjs
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var v = function(h) {
      var y = h;
      return y ? typeof y._ref == "string" : false;
    }, c = function(h) {
      var y = h;
      return y ? typeof y._id == "string" : false;
    }, g = function(h) {
      var y = h;
      return y && y.asset ? typeof y.asset.url == "string" : false;
    };
    function u(p) {
      if (!p)
        return null;
    ...
    function ae(p) {
      return p && "config" in p ? typeof p.config == "function" : false;
    }
    function he(p) {
      return p && "clientConfig" in p ? typeof p.clientConfig == "object" : false;
    }
    function ve(p) {
...
function hr(t2) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? dr(Object(r), true).forEach(function(n) {
      zn(t2, n, r[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(r)) : dr(Object(r)).forEach(function(n) {
...
function et(t2) {
  return t2._type === "span" && "text" in t2 && typeof t2.text == "string" && (t2.marks === void 0 || Array.isArray(t2.marks) && t2.marks.every((e) => typeof e == "string"));
}
function Wr(t2) {
  return typeof t2._type == "string" && t2._type[0] !== "@" && (!("markDefs" in t2) || Array.isArray(t2.markDefs) && t2.markDefs.every((e) => typeof e._key == "string")) && "children" in t2 && Array.isArray(t2.children) && t2.children.every((e) => typeof e == "object" && "_type" in e);
}
function Xr(t2) {
  return Wr(t2) && "listItem" in t2 && typeof t2.listItem == "string" && (t2.level === void 0 || typeof t2.level == "number");
}
function Gr(t2) {
  return t2._type === "@list";
}
function Jr(t2) {
  return t2._type === "@span";
}
function Qr(t2) {
  return t2._type === "@text";
}
var vr = ["strong", "em", "code", "underline", "strike-through"];
function Vn(t2, e, r) {
  if (!et(t2) || !t2.marks)
    return [];
  if (!t2.marks.length)
    return [];
  const n = t2.marks.slice(), i = {};
  return n.forEach((o) => {
    i[o] = 1;
...
function Wn(t2) {
  var e;
  const { children: r, markDefs: n = [] } = t2;
  if (!r || !r.length)
    return [];
...
function Gn(t2, e) {
  return (t2.level || 1) === e.level && t2.listItem === e.listItem;
}
function Ge(t2, e, r) {
  return { _type: "@list", _key: "".concat(t2._key || "".concat(e), "-parent"), mode: r, level: t2.level || 1, listItem: t2.listItem, children: [t2] };
}
function Rt(t2, e) {
  const r = e.level || 1, n = e.listItem || "normal", i = typeof e.listItem == "string";
  if (Gr(t2) && (t2.level || 1) === r && i && (t2.listItem || "normal") === n)
    return t2;
  if (!("children" in t2))
    return;
  const o = t2.children[t2.children.length - 1];
  return o && !et(o) ? Rt(o, e) : void 0;
}
function Yr(t2) {
  let e = "";
  return t2.children.forEach((r) => {
...
var yr = (t2, e, r) => e in t2 ? Jn(t2, e, { enumerable: true, configurable: true, writable: true, value: r }) : t2[e] = r;
var De = (t2, e) => {
  for (var r in e || (e = {}))
    Kr.call(e, r) && yr(t2, r, e[r]);
  if (tt)
    for (var r of tt(e))
      Zr.call(e, r) && yr(t2, r, e[r]);
  return t2;
};
var At = (t2, e) => Qn(t2, Yn(e));
var $t = (t2, e) => {
  var r = {};
  for (var n in t2)
    Kr.call(t2, n) && e.indexOf(n) < 0 && (r[n] = t2[n]);
  if (t2 != null && tt)
    for (var n of tt(t2))
      e.indexOf(n) < 0 && Zr.call(t2, n) && (r[n] = t2[n]);
  return r;
};
var Kn = ["http", "https", "mailto", "tel"];
var Zn = {
  "&": "amp",
  "<": "lt",
  ">": "gt",
...
function en(t2) {
  return t2.replace(/[&<>"']/g, (e) => `&${Zn[e]};`);
}
function ei(t2) {
  const e = (t2 || "").trim(), r = e.charAt(0);
  if (r === "#" || r === "/")
    return true;
  const n = e.indexOf(":");
  if (n === -1)
...
var ti = ({ children: t2, value: e }) => {
  const r = (e == null ? void 0 : e.href) || "";
  return ei(r) ? `<a href="${en(r)}">${t2}</a>` : t2;
};
var ri = {
  em: ({ children: t2 }) => `<em>${t2}</em>`,
  strong: ({ children: t2 }) => `<strong>${t2}</strong>`,
  code: ({ children: t2 }) => `<code>${t2}</code>`,
  underline: ({ children: t2 }) => `<span style="text-decoration:underline">${t2}</span>`,
  "strike-through": ({ children: t2 }) => `<del>${t2}</del>`,
  link: ti
};
var ni = {
  number: ({ children: t2 }) => `<ol>${t2}</ol>`,
  bullet: ({ children: t2 }) => `<ul>${t2}</ul>`
};
var ii = ({ children: t2 }) => `<li>${t2}</li>`;
var Be = (t2, e) => `Unknown ${t2}, specify a component for it in the \`components.${e}\` option`;
var tn = (t2) => Be(`block type "${t2}"`, "types");
var oi = (t2) => Be(`mark type "${t2}"`, "marks");
var ai = (t2) => Be(`block style "${t2}"`, "block");
var si = (t2) => Be(`list style "${t2}"`, "list");
var ui = (t2) => Be(`list item style "${t2}"`, "listItem");
function ci(t2) {
  console.warn(t2);
}
var fi = ({
...
var li = ({
  markType: t2,
  children: e
}) => `<span class="unknown__pt__mark__${t2}">${e}</span>`;
var pi = ({
  children: t2
}) => `<p>${t2}</p>`;
var di = ({ children: t2 }) => `<ul>${t2}</ul>`;
var hi = ({
  children: t2
}) => `<li>${t2}</li>`;
var vi = () => "<br/>";
var yi = {
  normal: ({ children: t2 }) => `<p>${t2}</p>`,
  blockquote: ({ children: t2 }) => `<blockquote>${t2}</blockquote>`,
  h1: ({ children: t2 }) => `<h1>${t2}</h1>`,
  h2: ({ children: t2 }) => `<h2>${t2}</h2>`,
  h3: ({ children: t2 }) => `<h3>${t2}</h3>`,
  h4: ({ children: t2 }) => `<h4>${t2}</h4>`,
  h5: ({ children: t2 }) => `<h5>${t2}</h5>`,
  h6: ({ children: t2 }) => `<h6>${t2}</h6>`
};
var gr = {
  types: {},
  block: yi,
...
function mi(t2, e = {}) {
  ...
  } = e, i = n || wi, o = Array.isArray(t2) ? t2 : [t2], a = Xn(o, "html"), s = r ? gi(gr, r) : gr, v = bi(s, i);
  return a.map((g, u) => v({ node: g, index: u, isInline: false, renderNode: v })).join("");
}
var bi = (t2, e) => {
  function r(c) {
  ...
  function n(c, g) {
    const u = mr({ node: c, index: g, isInline: false, renderNode: r }), d = t2.listItem, x = (typeof d == "function" ? d : d[c.listItem]) || t2.unknownListItem;
    if (x === t2.unknownListItem) {
    ...
    if (c.style && c.style !== "normal") {
      ...
      S = r({ node: j, index: g, isInline: false, renderNode: r });
    }
    return x({ value: c, index: g, isInline: false, renderNode: r, children: S });
  }
  function i(c, g) {
    const u = c.children.map((S, T) => r({
      ...
      isInline: false,
      renderNode: r
    })), d = t2.list, x = (typeof d == "function" ? d : d[c.listItem]) || t2.unknownList;
    if (x === t2.unknownList) {
      const S = c.listItem || "bullet";
      e(si(S), { nodeType: "listStyle", type: S });
    }
    return x({ value: c, index: g, isInline: false, renderNode: r, children: u.join("") });
  }
  function o(c) {
    const { markDef: g, markType: u, markKey: d } = c, O = t2.marks[u] || t2.unknownMark, x = c.children.map((S, T) => r({ node: S, index: T, isInline: true, renderNode: r }));
    return O === t2.unknownMark && e(oi(u), { nodeType: "mark", type: u }), O({
      text: Yr(c),
      value: g,
      markType: u,
      markKey: d,
  ...
  function a(c, g, u) {
    const d = mr({ node: c, index: g, isInline: u, renderNode: r }), O = $t(d, ["_key"]), x = O.node.style || "normal", T = (typeof t2.block == "function" ? t2.block : t2.block[x]) || t2.unknownBlockStyle;
    return T === t2.unknownBlockStyle && e(ai(x), {
      nodeType: "blockStyle",
      type: x
...
function mr(t2) {
  const { node: e, index: r, isInline: n, renderNode: i } = t2, a = Wn(e).map((s, v) => i({ node: s, isInline: true, index: v, renderNode: i }));
  return {
    _key: e._key || `block-${r}`,
    children: a.join(""),
    index: r,
...
var X = Si() ? Object.assign : function(t2, e) {
  for (var r, n = Ei(t2), i, o = 1; o < arguments.length; o++) {
...
ze.config = {
  Promise: void 0,
  set useDeprecatedSynchronousErrorHandling(t2) {
    if (t2) {
      var e = new Error();
...
Gt.isArray = function() {
  return Array.isArray || function(t2) {
...
` + e.map(function(r, n) {
  ...
  return t2.prototype = Object.create(Error.prototype), t2;
}();
...
var qi = function() {
  function t2(e) {
    this.closed = false, this._parentOrParents = null, this._subscriptions = null, e && (this._ctorUnsubscribe = true, this._unsubscribe = e);
  }
  return t2.prototype.unsubscribe = function() {
    ...
    if (!this.closed) {
      ...
      if (this.closed = true, this._parentOrParents = null, this._subscriptions = null, n instanceof t2)
        n.remove(this);
      else if (n !== null)
...
Xt.Subscription = qi;
function wr(t2) {
  return t2.reduce(function(e, r) {
    return e.concat(r instanceof Ke.UnsubscriptionError ? r.errors : r);
  }, []);
}
var Yt = {};
(function(t2) {
  Object.defineProperty(t2, "__esModule", { value: true }), t2.rxSubscriber = function() {
    return typeof Symbol == "function" ? Symbol("rxSubscriber") : "@@rxSubscriber_" + Math.random();
  }(), t2.$$rxSubscriber = t2.rxSubscriber;
})(Yt);
var rn = ue && ue.__extends || function() {
  var t2 = function(e, r) {
    return t2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(n, i) {
      n.__proto__ = i;
    } || function(n, i) {
      for (var o in i)
...
var nn = function(t2) {
  ...
  function e(r, n, i) {
    ...
    switch (o.syncErrorValue = null, o.syncErrorThrown = false, o.syncErrorThrowable = false, o.isStopped = false, arguments.length) {
      ...
      case 1:
        ...
        if (typeof r == "object") {
          r instanceof e ? (o.syncErrorThrowable = r.syncErrorThrowable, o.destination = r, r.add(o)) : (o.syncErrorThrowable = true, o.destination = new Dt(o, r));
          break;
        }
      default:
        o.syncErrorThrowable = true, o.destination = new Dt(o, r, n, i);
        break;
    }
    return o;
  }
  return e.prototype[ki.rxSubscriber] = function() {
    ...
    this.closed || (this.isStopped = true, t2.prototype.unsubscribe.call(this));
    ...
    return this._parentOrParents = null, this.unsubscribe(), this.closed = false, this.isStopped = false, this._parentOrParents = r, this;
  }, e;
}(Di.Subscription);
Pe.Subscriber = nn;
var Dt = function(t2) {
  ...
  return e.prototype.next = function(r) {
    ...
    if (!this.isStopped) {
      ...
      if (this._error)
        ...
        i ? (n.syncErrorValue = r, n.syncErrorThrown = true) : Je.hostReportError(r), this.unsubscribe();
      else {
    ...
    try {
      ...
      return Re.config.useDeprecatedSynchronousErrorHandling ? (r.syncErrorValue = o, r.syncErrorThrown = true, true) : (Je.hostReportError(o), true);
    }
    return false;
...
function Mi(t2) {
  for (; t2; ) {
    var e = t2, r = e.closed, n = e.destination, i = e.isStopped;
    if (r || i)
      return false;
    n && n instanceof Ui.Subscriber ? t2 = n : t2 = null;
  }
  return true;
}
...
function Li(t2, e, r) {
  if (t2) {
    if (t2 instanceof mt.Subscriber)
      return t2;
    if (t2[Or.rxSubscriber])
      return t2[Or.rxSubscriber]();
  }
  return !t2 && !e && !r ? new mt.Subscriber(Hi.empty) : new mt.Subscriber(t2, e, r);
}
Kt.toSubscriber = Li;
var Zt = {};
...
st.pipe = Bi;
function on(t2) {
  return t2.length === 0 ? Ni.identity : t2.length === 1 ? t2[0] : function(r) {
    return t2.reduce(function(n, i) {
      return i(n);
    }, r);
  };
}
...
var Gi = function() {
  function t2(e) {
    this._isScalar = false, e && (this._subscribe = e);
  }
  return t2.prototype.lift = function(e) {
    var r = new t2();
    return r.source = this, r.operator = e, r;
  }, t2.prototype.subscribe = function(e, r, n) {
    var i = this.operator, o = Vi.toSubscriber(e, r, n);
    if (i ? o.add(i.call(o, this.source)) : o.add(this.source || Ze.config.useDeprecatedSynchronousErrorHandling && !o.syncErrorThrowable ? this._subscribe(o) : this._trySubscribe(o)), Ze.config.useDeprecatedSynchronousErrorHandling && o.syncErrorThrowable && (o.syncErrorThrowable = false, o.syncErrorThrown))
      throw o.syncErrorValue;
    return o;
  }, t2.prototype._trySubscribe = function(e) {
    try {
      return this._subscribe(e);
    } catch (r) {
      Ze.config.useDeprecatedSynchronousErrorHandling && (e.syncErrorThrown = true, e.syncErrorValue = r), zi.canReportError(e) ? e.error(r) : console.warn(r);
    }
  }, t2.prototype.forEach = function(e, r) {
    var n = this;
  ...
  }, t2.prototype._subscribe = function(e) {
    var r = this.source;
    return r && r.subscribe(e);
  }, t2.prototype[Wi.observable] = function() {
    return this;
  }, t2.prototype.pipe = function() {
    for (var e = [], r = 0; r < arguments.length; r++)
      e[r] = arguments[r];
    return e.length === 0 ? this : Xi.pipeFromArray(e)(this);
  }, t2.prototype.toPromise = function(e) {
    var r = this;
  ...
  }, t2.create = function(e) {
    return new t2(e);
  }, t2;
}();
Vt.Observable = Gi;
function Er(t2) {
  if (t2 || (t2 = Ze.config.Promise || Promise), !t2)
    throw new Error("no Promise impl found");
  return t2;
}
var tr = {};
var Ji = ue && ue.__extends || function() {
  var t2 = function(e, r) {
    return t2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(n, i) {
      n.__proto__ = i;
    } || function(n, i) {
...
var Ki = function() {
  ...
  return t2.prototype.call = function(e, r) {
...
(function(t2) {
  ...
  }, t2.hasDataset = function(i) {
    if (!i.dataset)
      throw new Error("`dataset` must be provided to perform queries");
    return i.dataset || "";
  }, t2.requestTag = function(i) {
...
function Ut() {
  var t2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [], e = arguments.length > 1 ? arguments[1] : void 0, r = arguments.length > 2 ? arguments[2] : void 0;
  this.trxId = r, this.operations = t2, this.client = e;
}
_t(Ut.prototype, {
  clone: function() {
...
function vo(t2, e) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (i = 0; i < o.length; i++)
      n = o[i], !(e.indexOf(n) >= 0) && Object.prototype.propertyIsEnumerable.call(t2, n) && (r[n] = t2[n]);
  }
  return r;
}
function yo(t2, e) {
  if (t2 == null)
    return {};
  var r = {}, n = Object.keys(t2), i, o;
  for (o = 0; o < n.length; o++)
    i = n[o], !(e.indexOf(i) >= 0) && (r[i] = t2[i]);
  return r;
}
var $e = encodeURIComponent;
var fn = function(t2) {
  var e = t2.query, r = t2.params, n = r === void 0 ? {} : r, i = t2.options, o = i === void 0 ? {} : i, a = o.tag, s = vo(o, ho), v = "query=".concat($e(e)), c = a ? "?tag=".concat($e(a), "&").concat(v) : "?".concat(v), g = Object.keys(n).reduce(function(u, d) {
...
(function(t2, e) {
  (function(r) {
    ...
    }, false)), o == null && s != null && (o = function() {
    ...
    var k = function() {
      try {
        return new O().decode(new x().encode("test"), { stream: true }) === "test";
      } catch (l) {
    ...
    function M(l) {
      this.withCredentials = false, this.readyState = 0, this.status = 0, this.statusText = "", this.responseText = "", this.onprogress = q, this.onload = q, this.onerror = q, this.onreadystatechange = q, this._contentType = "", this._xhr = l, this._sendTimeout = 0, this._abort = q;
    }
    M.prototype.open = function(l, b) {
      ...
      "onload" in m && (m.onload = function(P) {
        ...
        D(P);
      }), ("contentType" in m || !("ontimeout" in o.prototype)) && (b += (b.indexOf("?") === -1 ? "?" : "&") + "padding=true"), m.open(l, b, true), "readyState" in m && (E = n(function() {
        U();
      }, 0));
...
`), m = 0; m < w.length; m += 1) {
          ...
          var Me = function() {
            F.read().then(function(te) {
              if (te.done)
                ...
                var Y = U.decode(te.value, { stream: true });
                w(Y), Me();
              }
            }).catch(function(te) {
              me(te);
    ...
    B.prototype.dispatchEvent = function(l) {
      ...
      m == null && (m = [], w[l] = m);
      for (var I = false, E = 0; E < m.length; E += 1)
        m[E] === b && (I = true);
      I || m.push(b);
    ...
    function Hn(l, b, w) {
      b = String(b);
      var m = Boolean(w.withCredentials), I = w.lastEventIdQueryParameterName || "lastEventId", E = ge(1e3), R = Ue(w.heartbeatTimeout, 45e3), F = "", $ = E, D = false, U = 0, P = w.headers || {}, N = w.Transport, me = Mn && N == null ? void 0 : new M(N != null ? new N() : Un()), Me = N != null && typeof N != "string" ? new N() : me == null ? new L() : new he(), te = void 0, Y = 0, fe = _, xe = "", We = "", be = "", Xe = "", K = z, vt = 0, Ie = 0, Ln = function(W, V, re, ne) {
        if (fe === A)
...
`, xe += _e) : we === "id" ? We = _e : we === "event" ? be = _e : we === "retry" ? (E = Ue(_e, E), $ = E) : we === "heartbeatTimeout" && (R = Ue(_e, R), Y !== 0 && (i(Y), Y = n(function() {
        ...
        if (Y = 0, fe !== _) {
          if (!D && te != null)
            ...
            D = false, Y = n(function() {
              He();
            }, W);
          }
          return;
        }
        D = false, U = 0, Y = n(function() {
          He();
...
var mo = rt;
var bo = mo.EventSourcePolyfill;
var wo = function(t2, e) {
  return e.reduce(function(r, n) {
    return typeof t2[n] > "u" || (r[n] = t2[n]), r;
  }, {});
};
var _o = function(t2, e) {
  return Object.keys(e).concat(Object.keys(t2)).reduce(function(r, n) {
    return r[n] = typeof t2[n] > "u" ? e[n] : t2[n], r;
  }, {});
};
function Ir(t2, e) {
  var r = Object.keys(t2);
...
function Pr(t2) {
  for (var e = 1; e < arguments.length; e++) {
    var r = arguments[e] != null ? arguments[e] : {};
    e % 2 ? Ir(Object(r), true).forEach(function(n) {
      Oo(t2, n, r[n]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t2, Object.getOwnPropertyDescriptors(r)) : Ir(Object(r)).forEach(function(n) {
      Object.defineProperty(t2, n, Object.getOwnPropertyDescriptor(r, n));
    });
  }
  return t2;
...
var xo = 16e3 - 1200;
var Tr = Io;
var jo = ["includePreviousRevision", "includeResult", "visibility", "effectFormat", "tag"];
var Ro = {
  includeResult: true
};
var Ao = function(e, r) {
  ...
  return (a || s) && (T.withCredentials = true), a && (T.headers = {
    ...
    function L() {
      k.removeEventListener("error", oe, false), k.removeEventListener("channelError", ae, false), k.removeEventListener("disconnect", ve, false), x.forEach(function(f) {
        return k.removeEventListener(f, he, false);
      }), k.close();
    }
    function B() {
      S && j.next({
    ...
    function p() {
      var f = new Tr(O, T);
      return f.addEventListener("error", oe, false), f.addEventListener("channelError", ae, false), f.addEventListener("disconnect", ve, false), x.forEach(function(C) {
        return f.addEventListener(C, he, false);
      }), f;
    }
    function h() {
      k = p();
...
function ln(t2) {
  try {
    var e = t2.data && JSON.parse(t2.data) || {};
    return Eo({
      type: t2.type
    }, e);
  } catch (r) {
...
function qo(t2) {
  return t2.error ? t2.error.description ? t2.error.description : typeof t2.error == "string" ? t2.error : JSON.stringify(t2.error, null, 2) : t2.message || "Unknown listener error";
}
function xr(t2, e, r) {
  return e in t2 ? Object.defineProperty(t2, e, { value: r, enumerable: true, configurable: true, writable: true }) : t2[e] = r, t2;
}
...
var Lo = function() {
  ...
  return {
    dryRun: e.dryRun,
    returnIds: true,
    returnDocuments: Ho(e.returnDocuments, true),
...
var zo = {
  ...
  fetch: function(e, r) {
    var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, i = n.filterResponse === false ? function(a) {
      return a;
    } : function(a) {
      return a.result;
...
var Wo = Se;
function dn(t2) {
  this.request = t2.request.bind(t2);
}
Vo(dn.prototype, {
  create: function(e, r) {
...
var Qo = function(t2) {
  var e = [];
  for (var r in t2)
    t2.hasOwnProperty(r) && e.push("".concat(encodeURIComponent(r), "=").concat(encodeURIComponent(t2[r])));
  return e.length > 0 ? "?".concat(e.join("&")) : "";
};
function Yo(t2, e) {
  return ta(t2) || ea(t2, e) || Zo(t2, e) || Ko();
}
function Ko() {
...
function Zo(t2, e) {
  if (t2) {
    ...
    if (r === "Object" && t2.constructor && (r = t2.constructor.name), r === "Map" || r === "Set")
...
function ea(t2, e) {
  var r = t2 == null ? null : typeof Symbol < "u" && t2[Symbol.iterator] || t2["@@iterator"];
  if (r != null) {
    var n = [], i = true, o = false, a, s;
    try {
      for (r = r.call(t2); !(i = (a = r.next()).done) && (n.push(a.value), !(e && n.length === e)); i = true)
        ;
    } catch (v) {
      o = true, s = v;
    } finally {
...
function oa(t2, e) {
  return typeof window > "u" || !(e instanceof window.File) ? t2 : vn({
    filename: t2.preserveFilename === false ? void 0 : e.name,
    contentType: e.type
  }, t2);
}
vn(gn.prototype, {
...
function ma(t2, e) {
  ...
  for (i in t2)
    if (va.call(t2, i)) {
      if (n = t2[i], !n && (n === null || n === ya || isNaN(n)) && (n = ""), i = qr(i), n = qr(n), i === null || n === null)
        continue;
      r.push(i + "=" + n);
    }
...
var ba = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/;
var _n = /[\n\r\t]/g;
var wa = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//;
var On = /:\d+$/;
var _a = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i;
var Oa = /^[a-zA-Z]:/;
function ir(t2) {
  return (t2 || "").toString().replace(ba, "");
}
var Ht = [
  ["#", "hash"],
...
function En(t2) {
  ...
  if (t2.protocol === "blob:")
    ...
    for (o in t2)
      o in Dr || (n[o] = t2[o]);
    n.slashes === void 0 && (n.slashes = wa.test(t2.href));
  }
  return n;
}
function pe(t2) {
  return t2 === "file:" || t2 === "ftp:" || t2 === "http:" || t2 === "https:" || t2 === "ws:" || t2 === "wss:";
}
function Sn(t2, e) {
  t2 = ir(t2), t2 = t2.replace(_n, ""), e = e || {};
  var r = _a.exec(t2), n = r[1] ? r[1].toLowerCase() : "", i = !!r[2], o = !!r[3], a = 0, s;
...
function Ea(t2, e) {
  if (t2 === "")
    return e;
  for (var r = (e || "/").split("/").slice(0, -1).concat(t2.split("/")), n = r.length, i = r[n - 1], o = false, a = 0; n--; )
    r[n] === "." ? r.splice(n, 1) : r[n] === ".." ? (r.splice(n, 1), a++) : a && (n === 0 && (o = true), r.splice(n, 1), a--);
  return o && r.unshift(""), (i === "." || i === "..") && r.push(""), r.join("/");
}
function de(t2, e, r) {
  if (t2 = ir(t2), t2 = t2.replace(_n, ""), !(this instanceof de))
    return new de(t2, e, r);
  var n, i, o, a, s, v, c = Ht.slice(), g = typeof e, u = this, d = 0;
  for (g !== "object" && g !== "string" && (r = e, e = null), r && typeof r != "function" && (r = ct.parse), e = En(e), i = Sn(t2 || "", e), n = !i.protocol && !i.slashes, u.slashes = i.slashes || n && e.slashes, u.protocol = i.protocol || e.protocol || "", t2 = i.rest, (i.protocol === "file:" && (i.slashesCount !== 2 || Oa.test(t2)) || !i.slashes && (i.protocol || i.slashesCount < 2 || !pe(u.protocol))) && (c[3] = [/(.*)/, "pathname"]); d < c.length; d++) {
    if (a = c[d], typeof a == "function") {
      t2 = a(t2, u);
      continue;
    }
    o = a[0], v = a[1], o !== o ? u[v] = t2 : typeof o == "string" ? (s = o === "@" ? t2.lastIndexOf(o) : t2.indexOf(o), ~s && (typeof a[2] == "number" ? (u[v] = t2.slice(0, s), t2 = t2.slice(s + a[2])) : (u[v] = t2.slice(s), t2 = t2.slice(0, s)))) : (s = o.exec(t2)) && (u[v] = s[1], t2 = t2.slice(0, s.index)), u[v] = u[v] || n && a[3] && e[v] || "", a[4] && (u[v] = u[v].toLowerCase());
  }
...
function Sa(t2, e, r) {
  ...
  switch (t2) {
    case "query":
      typeof e == "string" && e.length && (e = (r || ct.parse)(e)), n[t2] = e;
      break;
    case "port":
      n[t2] = e, wn(e, n.protocol) ? e && (n.host = n.hostname + ":" + e) : (n.host = n.hostname, n[t2] = "");
      break;
    case "hostname":
      n[t2] = e, n.port && (e += ":" + n.port), n.host = e;
      break;
    case "host":
      n[t2] = e, On.test(e) ? (e = e.split(":"), n.port = e.pop(), n.hostname = e.join(":")) : (n.hostname = e, n.port = "");
      break;
    case "protocol":
    ...
    case "hash":
      if (e) {
        var i = t2 === "pathname" ? "/" : "#";
        n[t2] = e.charAt(0) !== i ? i + e : e;
      } else
        n[t2] = e;
      break;
    case "username":
    case "password":
      n[t2] = encodeURIComponent(e);
      break;
    case "auth":
      var o = e.indexOf(":");
...
function Ia(t2) {
  (!t2 || typeof t2 != "function") && (t2 = ct.stringify);
  var e, r = this, n = r.host, i = r.protocol;
  i && i.charAt(i.length - 1) !== ":" && (i += ":");
  var o = i + (r.protocol && r.slashes || pe(r.protocol) ? "//" : "");
  return r.username ? (o += r.username, r.password && (o += ":" + r.password), o += "@") : r.password ? (o += ":" + r.password, o += "@") : r.protocol !== "file:" && pe(r.protocol) && !n && r.pathname !== "/" && (o += "@"), (n[n.length - 1] === ":" || On.test(r.hostname) && !r.port) && (n += ":"), o += n + r.pathname, e = typeof r.query == "object" ? t2(r.query) : r.query, e && (o += e.charAt(0) !== "?" ? "?" + e : e), r.hash && (o += r.hash), o;
}
...
var Pt = X;
var Ca = Pa;
var Ta = typeof navigator > "u" ? false : navigator.product === "ReactNative";
var xa = Object.prototype.hasOwnProperty;
var Lt = {
  timeout: Ta ? 6e4 : 12e4
};
var ja = function(t2) {
  var e = typeof t2 == "string" ? Pt({
    url: t2
  }, Lt) : Pt({}, Lt, t2), r = Ca(
    e.url,
    {},
...
function Aa(t2) {
  var e = {};
  for (var r in t2)
    t2[r] !== void 0 && (e[r] = t2[r]);
  return e;
}
var $a = /^https?:\/\//i;
var qa = function(t2) {
  if (!$a.test(t2.url))
    throw new Error('"'.concat(t2.url, '" is not a valid URL'));
};
var Ft = {};
var Da = {
  get exports() {
...
var Ur = ka;
var Ua = function(t2, e, r) {
  if (t2 === e)
    return true;
  var n = Ur.parse(t2, false, true), i = Ur.parse(e, false, true), o = n.port | 0 || (n.protocol === "https" ? 443 : 80), a = i.port | 0 || (i.protocol === "https" ? 443 : 80), s = {
...
ke.prototype.open = function(t2, e) {
  this._method = t2, this._url = e, this._resHeaders = "", this.readyState = 1, this.onreadystatechange();
};
...
ke.prototype.setRequestHeader = function(t2, e) {
  this._headers = this._headers || {}, this._headers[t2] = e;
};
ke.prototype.send = function(t2) {
...
var Ee = typeof window > "u" ? void 0 : window;
var Hr = Ee ? "xhr" : "fetch";
var ft = typeof XMLHttpRequest == "function" ? XMLHttpRequest : Ba;
var za = "withCredentials" in new ft();
var Va = typeof XDomainRequest > "u" ? void 0 : XDomainRequest;
var Pn = za ? ft : Va;
Ee || (ft = Mr, Pn = Mr);
var Wa = function(t2, e) {
  var r = t2.options, n = t2.applyMiddleware("finalizeOptions", r), i = {}, o = Ee && Ee.location && !Fa(Ee.location.href, n.url), a = t2.applyMiddleware("interceptRequest", void 0, {
    adapter: Hr,
    context: t2
  });
  if (a) {
  ...
  var c = o ? new Pn() : new ft(), g = Ee && Ee.XDomainRequest && c instanceof Ee.XDomainRequest, u = n.headers, d = n.timeout, O = false, x = false, S = false;
  ...
  return n.rawBody && (c.responseType = "arraybuffer"), t2.applyMiddleware("onRequest", {
    options: n,
    adapter: Hr,
    request: c,
    context: t2
  ...
  function q(L) {
    ...
    B.code = L, t2.channels.error.publish(B);
  }
  function M() {
...
var Qa = qa;
var Ya = Ft;
var Ka = ["request", "response", "progress", "error", "abort"];
var Lr = ["processOptions", "validateOptions", "interceptRequest", "finalizeOptions", "onRequest", "onResponse", "onError", "onReturn", "onHeaders"];
var Za = function t() {
...
var Fr = X;
var ts = function() {
  var t2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, e = t2.implementation || es.Observable;
  if (!e)
...
var ns = rs;
function Nr(t2) {
  return ns(t2) === true && Object.prototype.toString.call(t2) === "[object Object]";
}
var is = function(e) {
  var r, n;
  return !(Nr(e) === false || (r = e.constructor, typeof r != "function") || (n = r.prototype, Nr(n) === false) || n.hasOwnProperty("isPrototypeOf") === false);
};
function Bt(t2) {
...
var cs = function(t2) {
  return {
    onResponse: function(r) {
      var n = r.headers["content-type"] || "", i = t2 && t2.force || n.indexOf("application/json") !== -1;
...
function xn(t2) {
  var e = t2.body, r = {
    ...
    responseBody: vs(e, t2)
  };
  return e.error && e.message ? (r.message = "".concat(e.error, " - ").concat(e.message), r) : e.error && e.error.description ? (r.message = e.error.description, r.details = e.error, r) : (r.message = e.error || e.message || hs(t2), r);
}
function hs(t2) {
  var e = t2.statusMessage ? " ".concat(t2.statusMessage) : "";
  return "".concat(t2.method, "-request to ").concat(t2.url, " resulted in HTTP ").concat(t2.statusCode).concat(e);
}
function vs(t2, e) {
  var r = (e.headers["content-type"] || "").toLowerCase(), n = r.indexOf("application/json") !== -1;
  return n ? JSON.stringify(t2, null, 2) : t2;
}
Cn(ar);
Cn(sr);
or.ClientError = ar;
...
var Os = zt;
var Es = Ve;
var Ss = Es.Observable;
var jn = or;
var Rn = jn.ClientError;
var An = jn.ServerError;
var Is = {
...
var Cs = ys;
var Ts = Cs.concat([Ps, ws(), _s(), Os(), Is, bs({
  implementation: Ss
})]);
var $n = gs(Ts);
function lt(t2) {
...
var xs = lt;
var zr = X;
var js = "X-Sanity-Project-ID";
var Rs = function(t2) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = {}, n = e.token || t2.token;
  n && (r.Authorization = "Bearer ".concat(n)), !e.useGlobalApi && !t2.useProjectHostname && t2.projectId && (r[js] = t2.projectId);
  var i = Boolean(typeof e.withCredentials > "u" ? t2.token || t2.withCredentials : e.withCredentials), o = typeof e.timeout > "u" ? t2.timeout : e.timeout;
  return zr({}, e, {
    headers: zr({}, r, e.headers || {}),
    timeout: typeof o > "u" ? 5 * 60 * 1e3 : o,
    proxy: e.proxy || t2.proxy,
    json: true,
    withCredentials: i
  });
};
var qn = {};
var As = "https://docs.sanity.io/help/";
var Dn = function(e) {
  return As + e;
};
var pt = {};
var $s = function(t2) {
  var e = false, r;
  return function() {
    return e || (r = t2.apply(void 0, arguments), e = true), r;
  };
};
var ur = Dn;
var qs = $s;
...
(function(t2) {
  ...
  t2.defaultConfig = a, t2.initConfig = function(c, g) {
    var u = e({}, g, c);
  ...
  }, t2.validateApiVersion = function(g) {
    if (!(g === "1" || g === "X")) {
...
var Xs = Rs;
var kn = qn;
var Gs = kn.defaultConfig;
var Js = kn.initConfig;
var Qs = Se;
var Ys = function(e) {
  return e.toPromise();
};
function ie() {
  var t2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Gs;
  if (!(this instanceof ie))
    return new ie(t2);
  if (this.config(t2), this.assets = new zs(this), this.datasets = new Ns(this), this.projects = new Bs(this), this.users = new Vs(this), this.auth = new Ws(this), this.clientConfig.isPromiseAPI) {
...
qe(ie.prototype, {
  ...
  getUrl: function(e) {
    var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, n = r ? this.clientConfig.cdnUrl : this.clientConfig.url;
...
function Zs(t2) {
  const e = "virtual:sanity-init", r = "\0" + e;
  return {
    ...
    async load(n) {
      if (n === r)
        return `
          ...
          export const sanityClient = client(${JSON.stringify(t2)});
        `;
    }
  };
}
...
export {
  eu as createImageBuilder,
  ru as createSanityClient,
  ou as default,
  nu as groq,
  tu as portableTextToHtml,
  iu as useSanityClient
};
/*! Bundled license information:

astro-sanity/dist/astro-sanity.mjs:
  (*
  object-assign
  (c) Sindre Sorhus
  @license MIT
  *)
   ...
   *)
*/
//# sourceMappingURL=astro-sanity.js.map
